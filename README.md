...
1. Download the repo : https://github.com/forbot002/CloneBot-Heroku/archive/refs/heads/master.zip
2. Open the config.ini [(create)](https://pastebin.com/raw/VjkwPVtQ) file (inside the telegram_gcloner folder) and fill the following values :
